<div align="center">
  ...
  <p align="center">
    <code><b>SYSTEMS ARCHITECTURE // INTELLIGENT COMPUTE // CYBER-PHYSICAL INTERFACES</b></code>
  </p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>Generative AI workflows & LLM orchestration (LangChain, LlamaIndex)</li>
        <li>Retrieval-Augmented Generation (RAG) & prompt architecture</li>
        <li>Deep Learning (PyTorch) and high-throughput data analysis</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h4>Real-Time 3D & Game Engineering</h4>
      <ul>
        <li>Interactive engine architecture across Unity & Unreal Engine</li>
        <li>Real-time shader programming, simulation & physics</li>
        <li>Performant systems development in C# and C++</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h4>Industrial IoT & Cyber-Physical Systems</h4>
      <ul>
        <li>Sensor networks, telemetry protocols & edge device bridges</li>
        <li>Parametric CAD / CAM / CAE using Autodesk Fusion 360</li>
        <li>Microcontroller architecture & hardware automation</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h4>Full-Stack & Backend Systems</h4>
      <ul>
        <li>Enterprise microservices using Java & Spring Boot</li>
        <li>Scalable, low-latency REST API design</li>
        <li>Modular, high-concurrency distributed design</li>
      </ul>
    </td>
  </tr>
</table>
...
<details>
  <summary><b>View Verified Coursera Certifications</b></summary>
  <br />
